...
<body>
<div class="header">
    <a href="#default" class="logo">DE-BALOS</a>
...
<div class="bg-text">
  ...
  <p style="font-size:20px">Making the world greener is easy one <br>community at time.</p>
...
<!--======new section======--->
<div class="row-dif" style="background:creamwhite">
  <div class="col-dif">
      <h1 style="text-align:left">Make a Difference</h1><hr class="hr2">
    <div class="contents2">
      <h3>No For Profit</h3>
      <p class="par3">
  ...
  <div class="row2">
    <div class="columna">
      <form action="/action_page.php">      
        ...
        <input type="text" id="ynumber" name="yournumber" placeholder="Your number..">       
        <input type="text" id="subject" name="subject" placeholder="Subject..">
        <textarea id="message" name="message" placeholder="Write something.." style="height:135px"></textarea>
